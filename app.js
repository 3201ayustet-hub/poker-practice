  ...
  document.querySelector("#refArea").innerHTML=`
    <section class="card gacha-room museum">
      ...
      <div class="museum-shelves">
        ${grouped.map(g => `<div class="museum-section"><h3>${rarityIcon(g.rarity)} ${g.rarity}</h3><div class="collection-grid">${g.items.map(item=>`<div class="collection-card ${owned.has(item.id)?"owned":"locked"} rarity-${item.rarity}">
